    ...
    <div className="overflow-hidden pt-24">
      <section className="relative py-20 md:py-28">
        <div className="absolute inset-0">
          <Image src="https://images.unsplash.com/photo-1560518883-ce09059eeffa?w=1920&h=1080&fit=crop" alt={title} fill priority sizes="100vw" className="object-cover" />
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <motion.div {...fadeInUp}>
              <div className="relative rounded-2xl overflow-hidden h-80">
                <Image src="https://images.unsplash.com/photo-1600607687939-ce8a6c25118c?w=800&h=600&fit=crop" alt={title} fill sizes="(min-width: 1024px) 50vw, 100vw" className="object-cover" />
              </div>
            </motion.div>
          </div>
        </div>
...
const legalConveyancingFeatures = [
  { icon: Search, title: "Title Search & Verification", description: "Thorough investigation of property titles at the Land Registry." },
  { icon: FileText, title: "Contract Drafting", description: "Professional preparation of sale agreements and contracts." },
  { icon: Stamp, title: "Document Stamping", description: "Handling all stamp duty payments and documentation." },
  { icon: BookOpen, title: "Governor's Consent", description: "Processing applications for Governor's Consent where required." },
  { icon: ClipboardCheck, title: "Due Diligence", description: "Comprehensive checks for encumbrances, liens, and disputes." },
  { icon: HandshakeIcon, title: "Closing Support", description: "Representation and support during property closing." },
];

const legalConveyancingBenefits = [
  "Protection against fraud and disputes",
  "Clear and marketable title assurance",
  "Compliance with all legal requirements",
  "Expert handling of complex transactions",
  "Timely processing of applications",
  "Professional document preparation",
  "Peace of mind throughout the process",
  "Post-transaction support and advice",
];

const legalConveyancingProcess = [
  { step: "1", title: "Title Search", description: "Verify ownership and check for encumbrances." },
  { step: "2", title: "Documentation", description: "Prepare all necessary legal documents." },
  { step: "3", title: "Approvals", description: "Obtain required consents and approvals." },
  { step: "4", title: "Closing", description: "Complete transaction and transfer title." },
];

export default function LegalConveyancingPage() {
  return (
    <ServicePage
      badge="Legal & Conveyancing"
      title="Legal & Conveyancing Services"
      subtitle="Protect your investment with expert legal support for all property transactions."
      description="Our legal and conveyancing service ensures your property transactions are legally sound and protected. We handle all aspects of property law, from title verification to contract drafting and closing. Our team of experienced property lawyers works diligently to identify and resolve any legal issues before they become problems, giving you complete peace of mind. With extensive knowledge of Nigerian property law and Land Registry procedures, we ensure smooth and legally compliant transactions every time."
      icon={Scale}
      features={legalConveyancingFeatures}
      benefits={legalConveyancingBenefits}
      process={legalConveyancingProcess}
      ctaTitle="Need Legal Support for Your Property Transaction?"
      ctaDescription="Our experienced property lawyers are ready to guide you through every step. Contact us for a consultation."
    />
  );
}
