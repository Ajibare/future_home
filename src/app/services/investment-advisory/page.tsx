...
import {
  ...
  FileText, MapPin, Calculator, ClipboardCheck, HandshakeIcon, BarChart3, Target, PieChart,
} from "lucide-react";
...
const investmentAdvisoryFeatures = [
  { icon: BarChart3, title: "Market Analysis", description: "In-depth analysis of market trends, pricing patterns, and growth projections." },
  { icon: Target, title: "Property Sourcing", description: "We identify high-yield properties that match your investment criteria." },
  { icon: Calculator, title: "ROI Projections", description: "Detailed financial modeling with realistic return projections." },
  { icon: PieChart, title: "Portfolio Optimization", description: "Strategic advice on diversifying your real estate portfolio." },
  { icon: Shield, title: "Risk Assessment", description: "Comprehensive risk analysis and mitigation strategies." },
  { icon: HandshakeIcon, title: "Deal Structuring", description: "Expert negotiation and deal structuring for maximum benefit." },
];

const investmentAdvisoryBenefits = [
...
const investmentAdvisoryProcess = [
  { step: "1", title: "Consultation", description: "Understand your goals, budget, and risk appetite." },
  { step: "2", title: "Strategy", description: "Develop a personalized investment strategy." },
  { step: "3", title: "Sourcing", description: "Identify and present suitable opportunities." },
  { step: "4", title: "Acquisition", description: "Guide you through purchase and closing." },
];
...
export default function InvestmentAdvisoryPage() {
  return (
    <ServicePage
      ...
      subtitle="Build wealth through strategic real estate investments with expert guidance."
      description="Our investment advisory service helps you navigate the complex world of real estate investment. Whether you're a first-time investor or looking to expand our portfolio, our team provides the insights, analysis, and opportunities you need to make informed decisions and achieve your financial goals. We leverage deep market knowledge and data analytics to identify properties with the highest potential for capital appreciation and rental yield."
      icon={TrendingUp}
      features={investmentAdvisoryFeatures}
      benefits={investmentAdvisoryBenefits}
      process={investmentAdvisoryProcess}
      ctaTitle="Ready to Build Your Wealth?"
      ctaDescription="Schedule a consultation with our investment advisors and discover opportunities that align with your financial goals."
    />
  );
}
